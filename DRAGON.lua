...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/main/File_Bot/commands.lua") 
...
var = true  
elseif tonumber(user_id) == tonumber(99990000999) then
var = true  
...
local UserName = (data.username_ or "V_I_K_I_N_G2")
...
os.execute('wget https://raw.githubusercontent.com/main/DRAGON.lua')
...
usertext = '\n 🦅 العضو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'V_I_K_I_N_G2')..')'
status  = '\n 🦅 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🦅 الـعـضو   ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'V_I_K_I_N_G2')..') \n 🦅 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," 🦅 الـعـضو  : {["..data.first_name_.."](T.ME/V_I_K_I_N_G2)}\n 🦅 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🦅 عذرا  ← {["..data.first_name_.."](T.ME/V_I_K_I_N_G2)}\n 🦅 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'التواصل' or text == 'تواصل' or text == 'تواصل السورس' or text == '❴تواصل السورس❵' then 
local Text = [[ 
...
if text == 'مالك السورس' or text == 'سيزر' or text == 'عبده اصيل' then
local Text = [[
[سيزر مالك السورس لو حابب تتواصل معاه اتبع الزر إلى تحت ↓](t.me/s_e_z_r0)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'قناه السورس' or text == 'قناة السورس' or text == '♡━─━⊶❲𝐅𝐀𝐒𝐓𝐄𝐑❳⊷━─━♡' then
local Text = [[
لقناة سورس فاستر
اتبع الزر إلى تحت ↓
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹𝑺𝑶𝑼𝑹𝑪𝑬 𝑭𝑨𝑺𝑻𝑬𝑹˼', url="t.me/V_I_K_I_N_G2"}},
{{text = 'اضف البوت الي مجموعتك 🦅 ' ,url="t.me/"..dofile("./legand.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/V_I_K_I_N_G2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'مبرمج السورس' or text == 'المبرمج شادو' then
local Text = [[
مبرمج السورس شادو لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'مطور السورس' or text == 'فمبير' then
local Text = [[
[فامبير مطور السورس لو حابب تتواصل معاه اتبع الزر إلى تحت ↓](t.me/XxlllllllllllllllllllllllllllxX)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local Text = [[
[اليك بوتات تحميل 🌜
من جميع المواقع 🌝](t.me/V_I_K_I_N_G2)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{{text = '˹𝐂𝐇 𝐅𝐀𝐒𝐓𝐄𝐑˼', url="t.me/V_I_K_I_N_G2"}},
}  
local msg_id = msg.id_/2097152/0.5  
...
{{text = '˹𝑪𝑯  𝐅𝐀𝐒𝐓𝐄𝐑˼', url="t.me/V_I_K_I_N_G2"}},
{{text = '♪مــطــور الــبــوت•', url="http://t.me/"..sudos.UserName}},
{{text = '♪ اضغط لاضافه البوت لمجمعتك •' ,url="t.me/"..dofile("./legand.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/V_I_K_I_N_G2&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_, '🦅  بواسطه  ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'V_I_K_I_N_G2')..') \n🦅 تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🦅 تم تعطيل جلب الصوره \n 🦅 تم قفل البوتات  \n 🦅 تم قفل التكرار ،\n 🦅 تم قفل الروابط ،\n 🦅 تم قفل التوجيه ،\n 🦅 تم قفل الملصقات ،\n 🦅 تم قفل المتحركه ،\n 🦅 تم قفل الفيديو ،\n 🦅 تم قفل الفشار ،\n 🦅 تم قفل الانلاين ،\n 🦅 تم قفل تعديل المديا ،\n 🦅 تم وضع التكرار  ،\n 🦅 تم قفل الفارسيه  ،\n 🦅 تم وضع الايدي بدون صوره ،n  \n 🦅 تم تفعيل الحمايه  بواسطه ، ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'V_I_K_I_N_G2')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🦅 تم تفعيل جلب الصوره \n 🦅 تم  فتح البوتات  \n 🦅 تم  فتح التكرار \n 🦅 تم  فتح الروابط \n 🦅 تم  فتح التوجيه \n 🦅 تم  فتح الملصقات \n 🦅 تم  فتح المتحركه \n 🦅 تم  فتح الفيديو \n 🦅 تم  فتح الفشار \n 🦅 تم  فتح الانلاين \n 🦅 تم  فتح تعديل المديا \n 🦅 تم وضع التكرار  \n 🦅 تم  فتح الفارسيه  \n 🦅 تم وضع الايدي بصورهn \n 🦅 تم تعطيل الحمايه  بواسطه ، ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'V_I_K_I_N_G2')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوه من قبل    ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'V_I_K_I_N_G2')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🦅  بواسطه  ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'V_I_K_I_N_G2')..') \n 🦅 تـم قفـل التاك بالكتم ')
end,nil)   
...
local Groups = database:scard(bot_id..'Chek:Groups')  
if AddChannel(msg.sender_user_id_) == false then
local V_I_K_I_N_G2 = database:get(bot_id..'text:ch:user')
if V_I_K_I_N_G2 then
send(msg.chat_id_, msg.id_,'['..V_I_K_I_N_G2..']')
else
send(msg.chat_id_, msg.id_,' 🦅 لا تستطيع استخدام البوت \n  🦅 يرجى الاشتراك بالقناه اولا \n  🦅 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
usertext = '\n 🦅 العضو ← ['..result.title_..'](t.me/'..(username or 'V_I_K_I_N_G2')..')'
status  = '\n 🦅 تم حظره عام من {'..Groups..'} مجموعه'
texts = usertext..status
...
if text == "بس شادو بيصفي البار" and SudoBot(msg) then 
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 1000 
},function(ta,DRAGON) 
x = 0 
local list = DRAGON.members_ 
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n 🦅 اهلا بك في متجر ملفات فاستر\n 🦅 ملفات السورس ↓\n♡━─━⊶❲𝐅𝐀𝐒𝐓𝐄𝐑❳⊷━─━♡\n\n"
local TextE = "\n♡━─━⊶❲𝐅𝐀𝐒𝐓𝐄𝐑❳⊷━─━♡\n 🦅 علامة تعني { ✔️ } ملف مفعل\n 🦅 علامة تعني { ✖ } ملف معطل\n 🦅 قناة سورس فاستر↓\n".." 🦅 [اضغط هنا لدخول](t.me/V_I_K_I_N_G2) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/main/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🦅 الـعـضو   ← ['..data.first_name_..'](t.me/'..(data.username_ or 'V_I_K_I_N_G2')..')'
status  = '\n 🦅 تم ترقيته مطور'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n 🦅 الـعـضو   ← ['..result.title_..'](t.me/'..(username or 'V_I_K_I_N_G2')..')'
status  = '\n 🦅 تم ترقيته مطور'
texts = usertext..status
else
texts = ' 🦅 لا يوجد حساب بهاذا المعرف'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🦅 لعضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 'V_I_K_I_N_G2')..')'
status  = '\n 🦅 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🦅 الـعـضو   ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🦅 العضــو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 'V_I_K_I_N_G2')..')'
...
' }\n'..' 🦅  الايدي بالصوره  ← { '..idph..
' }\n'..' 🦅  الرفع  ← { '..setadd..
' }\n'..' 🦅  الحظر  ← { '..DRGm..' }\n\n 🦅♡━─━⊶❲𝐅𝐀𝐒𝐓𝐄𝐑❳⊷━─━♡\n 🦅 قناة سورس فاستر↓\n [ ❲[𝐒ΘΘ𝐍](t.me/V_I_K_I_N_G2)❳](t.me/V_I_K_I_N_G2) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🦅 الـعـضو   ← ['..result.title_..'](t.me/'..(text1[3] or 'V_I_K_I_N_G2')..')'..'\n 🦅 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'رتبتي' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[المبرمج شادو🥺🤍](t.me/V_I_K_I_N_G2)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور🦅', url="http://t.me/"..sudos.UserName},
...
if text == 'رتبتي' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[المالك سيزر🥺🤍](t.me/V_I_K_I_N_G2)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور🦅', url="http://t.me/"..sudos.UserName},
...
if text == 'رتبتي' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[المطور فامبير🥺🤍](t.me/V_I_K_I_N_G2)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور🦅', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[المطور الاساسي🥺🤍](t.me/V_I_K_I_N_G2)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور🦅', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المبرمج شادو نن عيني 🥺🤍](t.me/V_I_K_I_N_G2)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور🦅', url="http://t.me/"..sudos.UserName},
...
if text == 'انا مين' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[سيزر مالك السورس🥺🤍](t.me/V_I_K_I_N_G2)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور🦅', url="http://t.me/"..sudos.UserName},
...
if text == 'انا مين' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[فامبير مطور السورس🥺🤍](t.me/V_I_K_I_N_G2)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور🦅', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري نور عنيا🥺🤍](t.me/V_I_K_I_N_G2)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور🦅', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/V_I_K_I_N_G2)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/V_I_K_I_N_G2)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/V_I_K_I_N_G2)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/V_I_K_I_N_G2)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/V_I_K_I_N_G2)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/V_I_K_I_N_G2)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان تاخد رتبه😹 ](t.me/V_I_K_I_N_G2)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/V_I_K_I_N_G2)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[عضو قميل 🌝💙](t.me/V_I_K_I_N_G2)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[تم قفل التعريص بنجاح 😹😎](t.me/V_I_K_I_N_G2)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نعم الله عليك🙂](t.me/V_I_K_I_N_G2)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌝♥️](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[اعدل وشك ونت بتكلمني 😒](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بيعرج..😹💔🎶](t.me/V_I_K_I_N_G2)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عرفني عليها ينوبك ثواب🥺🙈](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[العفو يروحي🌝❤️](t.me/V_I_K_I_N_G2)')
return false
end

if text == "حلوه"  or text == "حلو" then
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/V_I_K_I_N_G2)')
return false
end

if text == "هموت"  or text == "بموت" then
send(msg.chat_id_,msg.id_, '[وتسبني لمين طيب..🥺💔](t.me/V_I_K_I_N_G2)')
return false
end

if text == "وه"  or text == "وهه" then
send(msg.chat_id_,msg.id_, '[بسيفلاح يعره مسمعش صوتكك😹🤸🏻‍♀🙊](t.me/V_I_K_I_N_G2)')
return false
end

if text == "اي"  or text == "ايي" then
send(msg.chat_id_,msg.id_, '[جتك اوهه م سامع ولا ايي😹👻](t.me/V_I_K_I_N_G2)')
return false
end
...
send(msg.chat_id_,msg.id_, '[فرح خالتك قريب😹💋💃🏻](t.me/V_I_K_I_N_G2)')
return false
end

if text == "حاضر"  or text == "حاتر" then
send(msg.chat_id_,msg.id_, '[بحبك وانت محترم كدهوان🙂💕](t.me/V_I_K_I_N_G2)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لف وارجع تاني م حوارر 😹🚶🏻‍♀♥️](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
if text == 'طاسه' then
send(msg.chat_id_,msg.id_, '[امك حلوة وابوك ورقاصة😂💃🏻](t.me/V_I_K_I_N_G2)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عادي يتفلق هنعملو اي..😒💔](t.me/V_I_K_I_N_G2)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[لاء متقولش نينينينني😹🏃🏻‍♀♥️](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
if text == "حبيبي" then
send(msg.chat_id_,msg.id_, '[اوه ياه 🌝😂](t.me/V_I_K_I_N_G2)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[اوعه ع الجمدان بقا حبيبتي وشغل عالي 🙈❤️](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[كفايه شقط يبني سيب حاجه لغيرك 😹👅](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ضحكتك عثل زيكك ينوحيي 🌝❤️](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خلصتت روحكك يبعيد😹🚶🏻‍♀💔](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[القمر ده شبهك..🙂♥️](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..🥺❤️](t.me/V_I_K_I_N_G2)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بنهش كتاكيت احنا هنا ولا اى😒💔](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
if text == "." then
send(msg.chat_id_,msg.id_, '[بتنقط لي ۍ حزين🙂💔](t.me/V_I_K_I_N_G2)')
return false
end

if text == "زخرفه"  or text == "زخرفة" then
send(msg.chat_id_,msg.id_, '[اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه شادو](t.me/V_I_K_I_N_G2)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يقطعني 😹🙆🏻‍♀♥️](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[انت الخير ياعمري..❤️](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ياحلولي هو كان فاكرني انسان ولا ايي 😹](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
if text == "تف" then
send(msg.chat_id_,msg.id_, '[اصفخص عليك منتن ءتفووووو😹👅](t.me/V_I_K_I_N_G2)')
return false
end
...
send(msg.chat_id_,msg.id_, '[حبككك اكترر ❤️](t.me/V_I_K_I_N_G2)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بعشقك يا روحي💋🥰](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[حصلخير اي هيجي منين الخير وانت هنا. 🙂😂](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام..🌚🖤](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[حصل حصوله 😹💜](t.me/V_I_K_I_N_G2)')
return false
end
end
end
...
if text == "اه" then
send(msg.chat_id_,msg.id_, '[اه اي يا قدع عيب 😹💔](t.me/V_I_K_I_N_G2)')
return false
end

if text == "بتحبني"  or text == "بتحبيني" then
send(msg.chat_id_,msg.id_, '[وهو القمر ميتحبش ؟؟ ❤️😂](t.me/V_I_K_I_N_G2)')
return false
end

if text == "بوتي" then
send(msg.chat_id_,msg.id_, '[قلب بوتكك من جواا 🥺♥️](t.me/V_I_K_I_N_G2)')
return false
end

if text == "هه"  or text == "ههه" then
send(msg.chat_id_,msg.id_, '[ضحكه مش سالكه 😳😂](t.me/V_I_K_I_N_G2)')
return false
end

if text == "باي"  or text == "بيي" then
send(msg.chat_id_,msg.id_, '[في رعايه الله 🥺❤️](t.me/V_I_K_I_N_G2)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا شغال متحورش😒💔](t.me/V_I_K_I_N_G2)')
return false
end
if text == "اسمي"  then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'V_I_K_I_N_G2')..')'
local iduser = result.sender_user_id_
...
{
{text = '☉اوامر اصحاب الرتب☉', callback_data="/help2"},
},
{
{text = '˹𝐂𝐇 𝐅𝐀𝐒𝐓𝐄𝐑˼ ', url="t.me/V_I_K_I_N_G2"},
},
...
{
{text = '𓆩𝐅𝐀𝐒𝐓𝐄𝐑𓆪', url="t.me/V_I_K_I_N_G2"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹S E Z R˼',url="t.me/s_e_z_r0"},{text = '˹V A M P I R E˼', url="t.me/XxlllllllllllllllllllllllllllxX"}},
{{text = '🦅T W A S O L🦅', url="t.me/Le_sn"}},
